...
const styles = StyleSheet.create({
  ...
  sessionName: { ...type.body, color: colors.inkSoft, marginTop: 2 },
  volume: {
    ...type.heroStat,
    marginTop: 16,
    color: colors.ink,
  },
  volumeLabel: { ...type.eyebrow, color: colors.textTertiary, marginTop: 2 },
  counts: { ...type.stat, color: colors.inkFaint, marginTop: 4 },
  footnote: { ...type.caption, color: colors.textTertiary, marginTop: 2 },
  divider: {
    width: '100%',
    borderTopWidth: 1,
  ...
  detailRow: { ...type.body, color: colors.inkFaint, paddingVertical: 2 },
  prRow: { ...type.action, ...type.tabular, color: colors.brass, paddingVertical: 2 },
  equivalence: {
    ...type.meta,
  ...
  doneBtnText: { ...type.cta, color: colors.paper },
});

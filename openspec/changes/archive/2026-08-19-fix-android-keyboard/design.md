...
- Footer lifts with the keyboard (visible Complete/Discard while typing) — accepted. **Superseded by `compact-session-footer`**: footer is now a compact single row and is hidden while the keyboard is open.

...
const styles = StyleSheet.create({
  ...
  backBtnText: { ...type.heroStat, lineHeight: 30, color: colors.ink },
  headerTitle: { ...type.title, color: colors.ink },
  headerMeta: { ...type.meta, color: colors.inkSoft, marginTop: 2 },
  headerBtn: {
  ...
  headerBtnText: { ...type.action, color: colors.ink },
  notePreview: {
  ...
  notePreviewText: { ...type.body, color: colors.inkSoft, fontStyle: 'italic' },
  listWrap: { flex: 1 },
  list: { flex: 1 },
  exerciseHeader: {
    flexDirection: 'row',
  ...
  exerciseName: { ...type.heading, color: colors.verdigris, flexShrink: 1 },
  exerciseChevron: {
    ...type.heading,
  ...
  summaryLine: { ...type.caption, color: colors.inkSoft, marginBottom: 6 },
  ...
  slotChipIndex: { ...type.stat, width: 18, color: colors.textTertiary },
  slotChipMain: { ...type.stat, color: colors.ink },
  slotChipWarmText: { ...type.stat, color: colors.textDisabled },
  ghostLabel: { ...type.micro, color: colors.textTertiary },
  chipDelta: { ...type.micro },
  notesToggle: { paddingVertical: 4 },
  notesToggleText: { ...type.action, color: colors.ink },
  notesBox: {
    backgroundColor: colors.paper,
    borderRadius: 4,
    borderWidth: 1,
  ...
  noteRow: { ...type.caption, color: colors.inkSoft },
  deltaText: { ...type.caption, fontWeight: '600' },
  prBadge: {
  ...
  prBadgeText: { ...type.micro, color: colors.paper },
  firstTimeBox: {
  ...
  firstTimeText: { ...type.meta, color: colors.brassText },
  countLabel: { ...type.caption, color: colors.textTertiary, marginBottom: 6 },
  setEntryRow: {
    flexDirection: 'row',
    gap: 8,
    alignItems: 'center',
  ...
  completeBtnText: { ...type.cta, color: colors.paper },
  discardBtn: {
    flex: 1,
    padding: 14,
    borderRadius: 6,
  ...
  discardBtnText: { ...type.action, color: colors.oxblood },
  modalHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',

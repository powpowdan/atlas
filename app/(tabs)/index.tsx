...
const styles = StyleSheet.create({
  ...
  activeTitle: { ...type.heading, color: colors.ink },
  activeMeta: { ...type.meta, color: colors.inkSoft, marginTop: 4, marginBottom: 16 },
  resumeBtn: {
  ...
  resumeBtnText: { ...type.cta, color: colors.paper },
  discardLink: { marginTop: 8, padding: 8, alignItems: 'center' },
  discardLinkText: { ...type.action, color: colors.oxblood },
  ...
  startHelp: { ...type.body, color: colors.inkSoft, textAlign: 'center', marginTop: 4, marginBottom: 16 },
  startBtn: {
    backgroundColor: colors.ink,
  ...
  startBtnText: { ...type.cta, color: colors.paper },
});

...
const styles = StyleSheet.create({
  ...
  recordLabel: { ...type.caption, color: colors.textTertiary, marginBottom: 4 },
  recordValue: { ...type.stat, color: colors.ink },
  recordValueEmpty: { ...type.stat, color: colors.textDisabled },
  recordDate: { ...type.caption, color: colors.textTertiary, marginTop: 2 },
  sectionLabel: { paddingHorizontal: 16, paddingTop: 16, paddingBottom: 4 },
  sectionLabelText: { ...type.sectionHeader, color: colors.textTertiary },
  tabRow: {
    flexDirection: 'row',
  ...
  tabText: { ...type.action, color: colors.inkSoft, fontWeight: '500' },

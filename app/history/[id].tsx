...
const styles = StyleSheet.create({
  ...
  removeExerciseBtnText: { color: colors.oxblood, fontWeight: '600', fontSize: 12 },
  setRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 6,
  ...
  addSetBtnText: { color: colors.inkSoft, fontWeight: '600', fontSize: 13 },
  addExerciseBtn: {
    margin: 16,
    padding: 12,
    borderWidth: 1,
  ...
  headerEditBtnText: { color: colors.ink, fontWeight: '600' },
